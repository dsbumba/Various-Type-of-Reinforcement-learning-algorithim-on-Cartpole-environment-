...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 26 21:18:05 2021
...
value_function = np.zeros(no_buckets) #define Q value
...
for no_episode in range(max_episodes):
    ...
    for time_step in range(max_time_steps):
        ...
        value_function[current_state] += learning_rate * (reward + discount* value_function[new_state] - value_function[current_state])
